...
import (
	...
	"github.com/ZihuaZhang/fabric/core/ledger/confighistory/confighistorytest"
	"github.com/ZihuaZhang/fabric/core/ledger/internal/version"
	kvledgermock "github.com/ZihuaZhang/fabric/core/ledger/kvledger/mock"
	"github.com/ZihuaZhang/fabric/core/ledger/kvledger/msgs"
	"github.com/ZihuaZhang/fabric/core/ledger/kvledger/txmgmt/statedb/statecouchdb"
...
func TestGenerateSnapshotErrors(t *testing.T) {
	...
	t.Run("block store returns error", func(t *testing.T) {
		...
		require.Contains(t, errStackTrace, "github.com/ZihuaZhang/fabric/common/ledger/blkstorage")
	})
	...
	t.Run("config history mgr returns error", func(t *testing.T) {
		...
		errStackTrace := fmt.Sprintf("%+v", err)
		require.Contains(t, errStackTrace, "internal leveldb error while obtaining db iterator")
		require.Contains(t, errStackTrace, "github.com/ZihuaZhang/fabric/core/ledger/confighistory")
	})
